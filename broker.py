...
class UpstoxBroker:
    ...
    def enter_long(self, quantity: int, tag: str = "ENTRY_LONG") -> str:
        ...
        Always uses MARKET order — guaranteed fill on signal is more important
        than saving a few ticks of spread on entry.  config.ORDER_TYPE is
        intentionally ignored here; it only governs exit orders.
        """
    ...
    def enter_short(self, quantity: int, tag: str = "ENTRY_SHORT") -> str:
        ...
        Always uses MARKET order — same rationale as enter_long.
        """
